...
public class AddProductUI {
    ...
    public AddProductUI() {
        ...
        String[] var10000 = new String[]{"ProductID ", "Name ", "Price ", "Quantity "};
        ...
        this.btnAdd.addActionListener(new AddProductUI.AddButtonListerner());
        this.btnCancel.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent actionEvent) {
                //JOptionPane.showMessageDialog((Component)null, "You click on Cancel button!!!");
                view.dispose();
            }
        });
    }
